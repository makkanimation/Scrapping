...
$result_All = $db->getQuery("select * from ".$table_pre.EMAIL_DOWNLOAD." where IsActive='1' order by ID desc");
$numRows=@$db->getNumRows($result_All);
$cond=" limit $eu,$limit";
$managePage = "outlook_downloadData.php";
$result = $db->getQuery("select * from ".$table_pre.EMAIL_DOWNLOAD." where IsActive='1' order by ID desc $cond");
											...
											if($result<>'')
											{
												...
												?>
													<tr bgcolor="#FFFFFF" height="35" style="display:'block';" id="showhide<?=$ID;?>">
														...
														<td align="left" ><?=$fetchRow['FirstName'];?></td>
														<td align="left" ><?=$fetchRow['LastName'];?></td>
												...
												<tr bgcolor="#FFFFFF" height="35">
													<td colspan="14" align="left" valign="top"><input class="loginbutton" type='submit' name='export3' value='Export All Data' onClick=" return collectselected_export();"><?
														if($numRows>$limit)
														{ ?>						
